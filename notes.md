Понял! Вот файл `notes.md`, приведенный к единому стилю с остальными файлами проекта:
...
# Конфиги синхронизируются через облако или локально через симлинк
# (чтобы не попадали в git). Чувствительные данные в файлах добавлены в .gitignore:
#
# ```
# tg
# ├── bot.log
...
# Данные хранятся отдельно в локальной/облачной папке,
# создаётся симлинк для добавления цитат в проект.
...
# Перейдите в папку с git проектом
